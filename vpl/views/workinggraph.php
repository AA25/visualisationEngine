...
//            //echo $submission->datesubmitted-$last_save_time.'and'.$rest_time;
//            echo '<br>';
...
//        }//else use the last $first_work
//        echo '<br>';
//        echo $last_save_time-$work_start+$first_work;
//        echo '<br>';
//        $workperiods[]=($last_save_time-$work_start+$first_work)/(3600.0);
//        echo var_dump($workperiods);
//    }
//    return $workperiods;
//}
//
...
if($userid<0){
    ...
    //var_dump($DB->get_record('user',array('id' => 13)));
    $title =sprintf("%s - %s",
        $vpl->fullname($user,false),
        get_string('numhours','',sprintf('%3.2f',$hours)));
    //var_dump(get_string('numhours','',sprintf('%3.2f',$hours)));
