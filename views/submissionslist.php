 ...
 *
 * @Additions Ademola Akingbade <ademola.akingbade.2013@mumail.ie>
 * @Detail Here lies the code for the main part of the submissions list tab page for each vpl activity.
 */
...
if($gradeable){
    $table->head  = array ('','',$namesortselect, $strsubtime,$strsubmisions,$strgrade,$strgrader,$strgradedon); //column headings
...
foreach ($all_data as $data) {
    ...
    if($data->submission == null){
        ...
        if($subinstance->dategraded>0){
            ...
            $gradeInt = (int)round($subinstance->grade);
        }else{
            $result=$submission->getCE();
            $text='';
...
//echo $OUTPUT->render($url_sel); //This is the drop down menu for submission selection.
