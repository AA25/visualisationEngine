...
//
//    $y_data=vpl_get_working_periods_testing($vpl, $userid);
//    //echo 'DrawMe'.'<br>';
//    //echo var_dump($y_data);
//    session_write_close();
//    $x_data=array();
//    $hours=0.0;
...
//    $title_x = 'this is title x'.' - '.$vpl->get_printable_name();
//    echo var_dump($y_data).'<br>'.var_dump($x_data);
//    // echo '<img src="'.vpl_graph::draw($title,$title_x,get_string('hours'),$x_data,$y_data,null,true).'" alt="workingperiods" />';
//    //vpl_graph::draw($title,$title_x,get_string('hours'),$x_dsata,$y_data,null,true);
//}